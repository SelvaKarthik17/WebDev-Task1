...
num[11].onclick = function(){
   element(11);
}
num[12].onclick = function(){
    element(12);
}
num[13].onclick = function(){
    element(13);
}
num[14].onclick = function(){
    element(14);
}
num[15].onclick = function(){
    element(15);
}
num[16].onclick = function(){
    element(16);
}
num[17].onclick = function(){
    element(17);
}
num[18].onclick = function(){
    element(18);
}
num[19].onclick = function(){
    element(19);
}
}
startnew();
